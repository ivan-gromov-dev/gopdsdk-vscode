...
export async function run(): Promise<void> {
  ...
  for (const command of ["gopdsdk.restartServer", "gopdsdk.refreshDiagnostics", "gopdsdk.showRuleHelp", "gopdsdk.troubleshoot", "gopdsdk.buildSimulator", "gopdsdk.runSimulator", "gopdsdk.checkDeviceConnection", "gopdsdk.buildDevice", "gopdsdk.runDevice", "gopdsdk.mountDeviceDisk", "gopdsdk.unmountDeviceDisk", "gopdsdk.showCrashLog", "gopdsdk.showErrorLog", "gopdsdk.selectTarget", "gopdsdk.showProjectHealth", "gopdsdk.remediateProjectHealth", "gopdsdk.createProject", "gopdsdk.configureAnalyzer", "gopdsdk.browseRules", "gopdsdk.addSuppression", "gopdsdk.createBaseline", "gopdsdk.updateBaseline", "gopdsdk.inspectBaseline", "gopdsdk.validateBaseline", "gopdsdk.compareTargets", "gopdsdk.refreshWorkspaceView", "gopdsdk.selectWorkspace"]) {
